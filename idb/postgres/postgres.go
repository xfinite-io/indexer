...
func (db *IndexerDb) GetSpecialAccounts() (accounts transactions.SpecialAddresses, err error) {
	var cache string
	...
	if err != nil || cache == "" {
		...
		if err != nil {
			return transactions.SpecialAddresses{}, fmt.Errorf("problem looking up special accounts from genesis block: %v", err)
		}
