...
CREATE SERVER redemptions FOREIGN DATA WRAPPER postgres_fdw OPTIONS (host 'redemptions-staging.postgres.database.azure.com',
...
-- Function to record and get closing balance in transaction history
